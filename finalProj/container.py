...
class Container:
    containerTypes = {"Small Box" : [1, 2, 3], "Medium Box" : [8,4,4], "Large Box" : [8,8,4]}
    ...
    def dimensions(self, containerType) -> None:
        print(f"Dimensions of the package are: {self.containerTypes[containerType][0]} x {self.containerTypes[containerType][1]} x {self.containerTypes[containerType][2]}.")
